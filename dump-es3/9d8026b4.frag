...
void main (void)
{
	...
	vec4 basecolor = texture(SampleTex, rawpos.xy*0.000144);
	basecolor = texture(ColorsTex, vec2( basecolor.r+0.00, 0.5));
...
// 		fogFactor=1.0;
//
// 	osg_FragColor = mix(osg_Fog_color ,finalColor, fogFactor);
